...
define('experiments/buttonSample',["require", "exports", "aurelia-framework"], function (require, exports, aurelia_framework_1) {
    "use strict";
    ...
    ], ButtonSample.prototype, "file", void 0);
    ButtonSample = __decorate([
        aurelia_framework_1.autoinject(),
...
define('models/button_code',["require", "exports"], function (require, exports) {
    ...
    var ButtonCodeModel = (function () {
        function ButtonCodeModel(styleName) {
            this.title = "Title";
        ...
        ButtonCodeModel.prototype.readFile = function (file) {
...
define('experiments/buttonSandbox',["require", "exports", "aurelia-framework", "aurelia-event-aggregator", "../models/button_code", "../baseViewModel"], function (require, exports, aurelia_framework_1, aurelia_event_aggregator_1, button_code_1, baseViewModel_1) {
    ...
    var ButtonSandbox = (function (_super) {
        ...
        function ButtonSandbox(ea) {
            var _this = _super.call(this, ea) || this;
            _this.one = "hover-button";
            _this.two = "twouuuu";
            _this.three = "hoverButton";
            _this.models = [];
            _this.models.push(new button_code_1.ButtonCodeModel("Style1"));
            _this.models.push(new button_code_1.ButtonCodeModel("Style2"));
            _this.models.push(new button_code_1.ButtonCodeModel("Style3"));
            return _this;
        }
...
define('experiments/hoverButton',["require", "exports", "aurelia-framework"], function (require, exports, aurelia_framework_1) {
    "use strict";
...
define('text!components/hoverButton.html', ['module'], function(module) { module.exports = "<template><require from=\"./hoverButton.css\"></require><button>This Button</button></template>"; });
define('text!components/hoverButton.css', ['module'], function(module) { module.exports = ""; });
...
define('text!experiments/buttonTemplate.html', ['module'], function(module) { module.exports = "<template><compose view=\"components/${file}.html\"></compose><!--https://github.com/aurelia/templating/issues/307--></template>"; });
