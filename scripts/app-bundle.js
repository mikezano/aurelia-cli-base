...
define('resume',["require", "exports", "aurelia-framework", "aurelia-event-aggregator"], function (require, exports, aurelia_framework_1, aurelia_event_aggregator_1) {
    "use strict";
    var Resume = (function () {
        function Resume(ea) {
            this.ea = ea;
        ...
        Resume.prototype.attached = function () {
            console.log("attached");
        };
        Resume.prototype.activated = function () {
            console.log("activated");
        };
        Resume.prototype.created = function () {
            console.log("created");
        };
        Resume.prototype.activate = function () {
            console.log("activate");
        };
        Resume.prototype.canActivate = function () {
...
define('resources/elements/hub',["require", "exports", "aurelia-framework", "aurelia-animator-velocity", "aurelia-router", "aurelia-event-aggregator"], function (require, exports, aurelia_framework_1, aurelia_animator_velocity_1, aurelia_router_1, aurelia_event_aggregator_1) {
    ...
    var Hub = Hub_1 = (function () {
        ...
        Hub.prototype.curtainAnimate = function (value) {
