...
define('experiments/cards.1',["require", "exports", "aurelia-framework", "aurelia-event-aggregator", "../baseViewModel"], function (require, exports, aurelia_framework_1, aurelia_event_aggregator_1, baseViewModel_1) {
    "use strict";
    var Cards = (function (_super) {
        __extends(Cards, _super);
        function Cards(ea) {
...
define('text!experiments/cards.1.css', ['module'], function(module) { module.exports = ".cards {\n  position: fixed;\n  top: 0;\n  left: 0;\n  bottom: 0;\n  right: 0;\n  z-index: 10;\n  background: radial-gradient(#888, #777);\n  padding: 10px;\n  overflow-y: scroll; }\n"; });
define('text!experiments/cards.1.html', ['module'], function(module) { module.exports = "<template><require from=\"./cards.css\"></require><require from=\"../resources/elements/componentElement\"></require><div class=\"au-animate cards\"><a href=\"javascript:history.back()\">Go Back</a><component-element file.bind=\"'simpleCard'\"></component-element><component-element file.bind=\"'simpleCard'\"></component-element></div></template>"; });
...
define('text!components/zoomButton.1.html', ['module'], function(module) { module.exports = "<template><require from=\"./zoomButton.css\"></require><button class=\"zoom\">Zoom</button></template>"; });
define('text!components/zoomButton.1.css', ['module'], function(module) { module.exports = ".zoom {\n  box-shadow: 2px 2px 4px black;\n  transition: all .2s ease-in-out; }\n  .zoom:hover {\n    transform: scale(1.1);\n    box-shadow: 4px 4px 8px #333333; }\n"; });
define('text!components/simpleTabs.html', ['module'], function(module) { module.exports = "<template><require from=\"./zoomButton.css\"></require><button class=\"zoom\">Zoom</button></template>"; });
define('text!components/simpleTabs.css', ['module'], function(module) { module.exports = ".zoom {\n  box-shadow: 2px 2px 4px black;\n  transition: all .2s ease-in-out; }\n  .zoom:hover {\n    transform: scale(1.1);\n    box-shadow: 4px 4px 8px #333333; }\n"; });
