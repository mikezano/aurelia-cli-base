...
define('text!components/simpleCard.html', ['module'], function(module) { module.exports = "<template><require from=\"./simpleCard.css\"></require><div class=\"simple-card\"><div class=\"simple-card__header\">Header<i class=\"fa fa-trash\"> </i><i class=\"fa fa-cubes\"></i></div><div class=\"simple-card__content\">Nunc semper pharetra mattis. Vestibulum laoreet, orci sit amet sodales tristique, metus justo tempus mauris, pulvinar commodo dui ante in libero. Nullam ullamcorper, leo malesuada condimentum condimentum, massa erat euismod diam, sit amet tristique elit enim ac dui. Quisque efficitur mi erat, eu cursus ligula cursus vel.</div></div></template>"; });
