...
define('text!css-tricks.html', ['module'], function(module) { module.exports = "<template><require from=\"./css-tricks.css\"></require><div class=\"au-animate tricks\"><div> <a href=\"#/buttons\">Rain</a></div><div> <a href=\"#/buttons\">Shapes</a></div><div><a href=\"#/buttons\">Grid</a></div><div><a href=\"#/buttons\">Overlap</a></div><div><a href=\"#/buttons\">Display</a></div><div><a href=\"#/buttons\">Absolute</a></div><div><a href=\"#/buttons\">Zano</a></div></div></template>"; });
define('text!css-tricks.css', ['module'], function(module) { module.exports = "css-tricks {\n  text-align: center;\n  font-size: 30px; }\n  css-tricks .tricks {\n    font-size: 20px; }\n\n.tricks div {\n  text-align: left;\n  margin-left: 40px; }\n\na {\n  color: white;\n  text-decoration: none;\n  text-align: left; }\n\n.tricks {\n  text-align: center; }\n"; });
